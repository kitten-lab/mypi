...
function displayVEN(){
    shelf = document.getElementById("myShelf");
    shelf.innerHTML += '<VEN class="ROM ' + VEN_Styles[ActiveVEN.style].name + '" id="' + ActiveVEN.vencode + '"></VEN>';
    romOnShelf = document.getElementById(ActiveVEN.vencode);
    romOnShelf.innerHTML += VEN_Styles[ActiveVEN.style].divLayout;
}
...
function Draw1(){
  ...
  CardDraw.innerText = Your1CardReading;
}
...
function LoadVEN(){
    ...
    ROM_SCREEN.innerHTML = `<div id="SiloROM_BaseBox" class="SiloROM_BaseBox">
    ...
    ROM_Header.innerHTML = "<h1 id='title'>" + ActiveVEN.vencode + "</h1>";
