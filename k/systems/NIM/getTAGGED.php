...
$.when(
  $.getJSON('http://d/_DEWEY/catalogs/a-node.tag.catalog.json'),
  $.getJSON('http://d/_DEWEY/catalogs/b-node.tag.catalog.json'),
  $.getJSON('http://d/_DEWEY/catalogs/c-node.tag.catalog.json')
