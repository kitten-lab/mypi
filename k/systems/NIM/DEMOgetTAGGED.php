...
$.when(
  $.getJSON('http://d/DEMO/_DEWEY/catalogs/a-node.tag.catalog.json'),
  $.getJSON('http://d/DEMO/_DEWEY/catalogs/b-node.tag.catalog.json'),
  $.getJSON('http://d/DEMO/_DEWEY/catalogs/c-node.tag.catalog.json')
